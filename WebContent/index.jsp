...
<header>
			<div id="cabecalho">
				<img id="logo" src="_imagens/topo-logado.jpg" alt="Cabeçalho do Sistema" title="margem superior logado" />
			...
			<img id="logo-dente" src="_imagens/botao-dente.png" alt="Logo da Empresa" />
</div>
</body>
</html>